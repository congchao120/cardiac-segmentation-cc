...
from unet_multi_model import unet_multi_model
seed = 1234
np.random.seed(seed)
...
if __name__== '__main__':
    ...
    model = unet_multi_model(input_shape, num_classes, transfer=True, contour_type=contour_type, weights=weight_path)
