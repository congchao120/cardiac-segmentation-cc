...
from .layers import unpool_with_argmax, mvn, crop
...
def inference(images, class_inc_bg = None, crop_size=256):

    images = (2.0/255.0) * images - 1.0
    images = tf.image.resize_image_with_crop_or_pad(images, crop_size, crop_size)
