...
from fcn_model_inv import fcn_model_inv
seed = 1234
np.random.seed(seed)
...
if __name__== '__main__':
    ...
    if contour_type == 'i':
        weight_path = 'C:\\Users\\congchao\\PycharmProjects\\cardiac-segmentation-master\\model_logs\\sunnybrook_i_fcn_inv.h5'
    elif contour_type == 'm':
        weight_path = 'C:\\Users\\congchao\\PycharmProjects\\cardiac-segmentation-master\\model_logs\\acdc_o_epoch40_aug32.h5'
    ...
    model = fcn_model_inv(input_shape, num_classes, num_filter=32, weights=weight_path)
    ...
    if K.backend() == 'tensorflow':
        tensorboard = TensorBoard(log_dir=os.path.join(save_path, 'logs_fcn_inv_II'), histogram_freq=10, write_graph=False,
    ...
    save_file = '_'.join(['sunnybrook', contour_type, 'fcn_inv_II']) + '.h5'
