...
def fcn_model_simple(input_shape, num_classes, weights=None):
...
if __name__ == '__main__':
    model = fcn_model_simple((100, 100, 1), 2, weights=None)
    plot_model(model, show_shapes=True, to_file='fcn_model_simple.png')
    model.summary()
