...
from unet_res_model_Inv import unet_res_model_Inv, dice_coef_each
...
def create_submission(contours, data_path, output_path ,contour_type = 'i'):
    if contour_type == 'i':
        weights = 'model_logs/sunnybrook_i_unetres_inv_drop_acdc.h5'
    else:
    ...
    model = unet_res_model_Inv(input_shape, num_classes, nb_filters=8, transfer=True, contour_type=contour_type, weights=weights)
...
if __name__== '__main__':
    ...
    save_dir = 'D:\cardiac_data\Sunnybrook\Sunnybrook_train_submission_unetres_inv_acdc_transf'
    print('\nProcessing online '+contour_type+' contours...')
    online_ctrs = list(map_all_contours(TRAIN_CONTOUR_PATH))
    create_submission(online_ctrs, TRAIN_IMG_PATH, TRAIN_OVERLAY_PATH, contour_type)

    save_dir = 'D:\cardiac_data\Sunnybrook\Sunnybrook_online_submission_unetres_inv_acdc_transf'
    print('\nProcessing online '+contour_type+' contours...')
    ...
    save_dir = 'D:\cardiac_data\Sunnybrook\Sunnybrook_val_submission_unetres_inv_acdc_transf'
