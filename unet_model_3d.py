...
def unet_model_3d(input_shape, pool_size=(2, 2, 2), n_labels=1, kernel=(3, 3, 3), initial_learning_rate=0.00001, deconvolution=False,
...
if __name__ == '__main__':
    model = unet_model_3d((128, 128, 5, 1), pool_size=(2, 2, 1), kernel=(7, 7, 5), n_labels=3, initial_learning_rate=0.00001,
                              deconvolution=False, depth=4, n_base_filters=8, include_label_wise_dice_coefficients=True,
                              batch_normalization=True)
    plot_model(model, show_shapes=True, to_file='unet_model_3d.png')
    model.summary()