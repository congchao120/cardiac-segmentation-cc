...
def fcn_model_transfer(input_shape, num_classes, weights=None, isTraining=True):
    ...
    if weights is not None:
        model.load_weights(weights, by_name=isTraining)
...
if __name__ == '__main__':
    model = fcn_model_transfer((100, 100, 1), 2, weights=None)
