...
def unet_res_model_Inv(input_shape, num_classes, nb_filters = 32, transfer=True, contour_type='i', weights=None):
...
if __name__ == '__main__':
    model = unet_res_model_Inv((128, 128, 1), 4, nb_filters=32, transfer=True, weights=None)
