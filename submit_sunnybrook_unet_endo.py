...
def create_submission(contours, data_path, output_path ,contour_type = 'i'):
    ...
    model = unet_model_inv(input_shape, num_classes, num_filters=8, transfer=True, contour_type=contour_type, weights=weights)
...
if __name__== '__main__':
    ...
    save_dir = 'D:\cardiac_data\Sunnybrook\Sunnybrook_train_submission_unet_inv_acdc'
    ...
    save_dir = 'D:\cardiac_data\Sunnybrook\Sunnybrook_online_submission_unet_inv_acdc'
    print('\nProcessing online '+contour_type+' contours...')
    ...
    save_dir = 'D:\cardiac_data\Sunnybrook\Sunnybrook_val_submission_unet_inv_acdc'
